...
/**
 * 
 * Abstract activity for AOPDS application.
 * 
 * Extends the Android basic activity adding the management of AOPDS preferences
 * and user. Every activity extending this class will be provided the
 * preferences and user manager.<br>
 * <br>
 * Moreover, the activity is automatically bound to a 'preferences listener'. We
 * mean that each time a preference changes (such as the language), the activity
 ...
 * 
 */
public abstract class AopdsActivity extends Activity implements
		AopdsPreferencesListener, AopdsUserChangedListener {

	/**
	 * The application preferences manager. Use this to get/set the preferences
	 * of the application.
	 */
	private AopdsPreferencesManager preferencesManager;

	/**
	 * The application user manager. Use this to get/change the current user of
	 * the application.
	 */
	...
	/**
	 * Creating the preferences and user managers, then bind the activity to the
	 * preferences listener. Turn the language of the activity to the language
	 * loaded by the preferences manager.
	 */
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		userManager = AopdsUserManager.getInstance(getApplicationContext());
	...
	/**
	 * Changes the Locale (so the language) of the android application
	 * configuration.
	 * 
	 * {@inheritDoc}
	 */
	public void onLanguageChanged(String language) {
		...
		AopdsLogger.info(getClass().getSimpleName(), "Changing Language to "
				+ language);
