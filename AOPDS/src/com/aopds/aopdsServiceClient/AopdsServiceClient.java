...
public class AopdsServiceClient {
	...
	public User signUpUser(String userEmail,
						   String userPassword, 
						   String userFirstName, 
						   String userLastName ) throws AopdsServiceConnectionImpossibleException, AopdsServiceException, AopdsServiceServerException {
		...
		if ( results.getReturnValue() == null ) {
			...
			try {
				...
				throw new AopdsServiceException(
					"The distant service responded with unexpected data type :" + returnValue.getClass() + 
					" for function " + AopdsServiceConnector.FUNCTION_SIGN_UP_USER, 
					e
				);
			}
	...
	public User modifyUser(
	...
	) throws AopdsServiceConnectionImpossibleException, AopdsServiceException, AopdsServiceServerException {
		...
		String res = connector.callFunction(
			AopdsServiceConnector.FUNCTION_MODIFY_USER,
			p,
			token
		);
		...
		if ( results.getReturnValue() == null ) {
			...
			try {
				...
				throw new AopdsServiceException(
					"The distant service responded with unexpected data type :" + returnValue.getClass() + 
					" for function " + AopdsServiceConnector.FUNCTION_MODIFY_USER, 
					e
				);
			}
...
public User connectUser(AopdsServiceAuthorizationToken token) throws AopdsServiceConnectionImpossibleException, AopdsServiceException, AopdsServiceServerException {
		...
		if ( results.getReturnValue() == null ) {
			...
			try {
				...
				throw new AopdsServiceException(
					"The distant service responded with unexpected data type :" + returnValue.getClass() + 
					" for function " + AopdsServiceConnector.FUNCTION_CONNECT_USER, 
					e
				);
			}
	...
	throws AopdsServiceException, AopdsServiceConnectionImpossibleException, AopdsServiceServerException 
	{
		
		AopdsLogger.info(getClass().getSimpleName(), "Getting all dictionaries");
		...
		if ( results.getReturnValue() == null ) {
			...
			try {
				...
				throw new AopdsServiceException(
					"The distant service responded with unexpected data type :" + returnValue.getClass() + 
					" for function " + AopdsServiceConnector.FUNCTION_GET_DICTIONARIES, 
					e
				);
			}
	...
	public int getNbSuggestion(long userId, AopdsServiceAuthorizationToken token) throws AopdsServiceConnectionImpossibleException, AopdsServiceException, AopdsServiceServerException
	{
		AopdsServiceParams p = new AopdsServiceParams();
		...
		else
		{
			...
			{
				throw new AopdsServiceException(
					"The distant service responded with unexpected data type :" + Integer.class.getClass() + 
					" for function " + AopdsServiceConnector.FUNCTION_GET_NB_SUGGESTION, 
					e
				);
			}
	...
	public List<Suggestion> getAllSuggestion(int userId, AopdsServiceAuthorizationToken token) throws AopdsServiceConnectionImpossibleException, AopdsServiceException, AopdsServiceServerException
	{
		AopdsServiceParams p = new AopdsServiceParams();
		...
		else
		{
			...
			catch (ClassCastException e)
			{
				throw new AopdsServiceException(
					"The distant service responded with unexpected data type :" + Integer.class.getClass() + 
					" for function " + AopdsServiceConnector.FUNCTION_GET_ALL_SUGGESTION, 
					e
				);
			}
	...
	public List<Suggestion> synchronizeSuggestions(
			List<Suggestion> unSynchronized, 
			List<Long> pending, 
			AopdsServiceAuthorizationToken token,
			Long userID) throws AopdsServiceConnectionImpossibleException, AopdsServiceServerException, AopdsServiceException
	{
		...
		else
		{
			...
			catch (ClassCastException e)
			{
				throw new AopdsServiceException(
					"The distant service responded with unexpected data type :" + Integer.class.getClass() + 
					" for function " + AopdsServiceConnector.FUNCTION_SYNCHRONIZE_SUGGESTION, 
					e
				);
			}
