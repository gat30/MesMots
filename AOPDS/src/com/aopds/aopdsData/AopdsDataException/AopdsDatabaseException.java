...
public abstract class AopdsDatabaseException extends Exception {
	...
	public AopdsDatabaseException(String databaseName, int databaseVersion,
			Exception error, String message) {

		super("AopdsDatabaseException: (" + databaseName + " version "
				+ databaseVersion + " ) " + message, error);
	...
	public String getFullDebugMessage() {
		...
		returning += this.getClass().getCanonicalName() + ": (" + databaseName
