...
public class AopdsErrorHandler {
	...
	public static void handleError(Exception e, int handlingMode,
			AopdsActivity activity) {
	...
	private static void handleSimpleError(Exception e, int mode,
			AopdsActivity activity) {
		AopdsLogger.error(activity.getClass().getSimpleName(), e.getMessage(),
				e);
	}

	private static void handleHttpError(Exception e, int mode,
			AopdsActivity activity) {

		switch (mode) {
		case DIALOG:
			AopdsDialog.displayAlertOkDialog(
					activity.getString(R.string.LABEL_CONNEXION_IMPOSSIBLE),
					activity);
			AopdsLogger.error(activity.getClass().getName(),
					activity.getString(R.string.LABEL_CONNEXION_IMPOSSIBLE), e);
			break;
		case LOGCAT:
			AopdsLogger.error(activity.getClass().getName(),
					activity.getString(R.string.LABEL_CONNEXION_IMPOSSIBLE), e);
	...
	private static void handleServiceError(Exception e, int mode,
			AopdsActivity activity) {

		switch (mode) {
		case DIALOG:
			AopdsDialog.displayAlertOkDialog(
					activity.getString(R.string.LABEL_SERVICE_EXCEPTION),
					activity);
			AopdsLogger.error(activity.getClass().getName(),
					activity.getString(R.string.LABEL_SERVICE_EXCEPTION), e);
			break;
		case LOGCAT:
			AopdsLogger.error(activity.getClass().getName(),
					activity.getString(R.string.LABEL_SERVICE_EXCEPTION), e);
	...
	private static void handleServiceServerError(Exception e, int mode,
			AopdsActivity activity) {
		...
		case AopdsServiceServerException.MISSING_PARAMETER:
			...
			case DIALOG:
				AopdsDialog
						.displayAlertOkDialog(
								message
										+ activity
												.getString(R.string.LABEL_MISSING_PARAMETER),
								activity);
				AopdsLogger
						.error(activity.getClass().getName(), activity
								.getString(R.string.LABEL_MISSING_PARAMETER), e);
				break;
			case LOGCAT:
				AopdsLogger
						.error(activity.getClass().getName(), activity
			...
			default:
				// recalls the function with default mode
				handleServiceServerError(e, SERVICE_SERVER_ERROR_DEFAULT,
						activity);
				break;
			}
			...
			case DIALOG:
				AopdsDialog
						.displayAlertOkDialog(
								message
										+ activity
												.getString(R.string.LABEL_UNDEFINED_FUNCTION),
								activity);
				AopdsLogger.error(activity.getClass().getName(),
						activity.getString(R.string.LABEL_UNDEFINED_FUNCTION),
						e);
				break;
			case LOGCAT:
				AopdsLogger.error(activity.getClass().getName(),
			...
			case DIALOG:
				AopdsDialog
						.displayAlertOkDialog(
								message
										+ activity
												.getString(R.string.LABEL_UNKNOWN_FUNCTION),
								activity);
				AopdsLogger.error(activity.getClass().getName(),
						activity.getString(R.string.LABEL_UNKNOWN_FUNCTION), e);
				break;
			case LOGCAT:
				AopdsLogger.error(activity.getClass().getName(),
						activity.getString(R.string.LABEL_UNKNOWN_FUNCTION), e);
			...
			case DIALOG:
				AopdsDialog
						.displayAlertOkDialog(
								message
										+ activity
												.getString(R.string.LABEL_FUNCTION_CALL_FAILED),
								activity);
				AopdsLogger
						.error(activity.getClass().getName(),
								activity.getString(R.string.LABEL_FUNCTION_CALL_FAILED),
								e);
				break;
			case LOGCAT:
				AopdsLogger
			...
			case DIALOG:
				AopdsDialog
						.displayAlertOkDialog(
								message
										+ activity
												.getString(R.string.LABEL_UNAUTHORIZED_ACCESS),
								activity);
				AopdsLogger.error(activity.getClass().getName(),
						activity.getString(R.string.LABEL_UNAUTHORIZED_ACCESS),
						e);
				break;
			case LOGCAT:
				AopdsLogger.error(activity.getClass().getName(),
			...
			case DIALOG:
				AopdsDialog
						.displayAlertOkDialog(
								message
										+ activity
												.getString(R.string.LABEL_INTERNAL_SERVER_ERROR),
								activity);
				AopdsLogger.error(activity.getClass().getName(), activity
						.getString(R.string.LABEL_INTERNAL_SERVER_ERROR), e);
				break;
			case LOGCAT:
				AopdsLogger.error(activity.getClass().getName(), activity
						.getString(R.string.LABEL_INTERNAL_SERVER_ERROR), e);
			...
			case DIALOG:
				AopdsDialog
						.displayAlertOkDialog(
								message
										+ activity
												.getString(R.string.LABEL_WRONG_PARAMETER_TYPE),
								activity);
				AopdsLogger
						.error(activity.getClass().getName(),
								activity.getString(R.string.LABEL_WRONG_PARAMETER_TYPE),
								e);
				break;
			case LOGCAT:
				AopdsLogger
	...
	private static void handleDatabaseError(Exception e, int mode,
			AopdsActivity activity) {
		...
		case DIALOG:
			AopdsDialog
					.displayAlertOkDialog(
							activity.getString(R.string.LABEL_DATABASE_ERROR),
							activity);
			AopdsLogger.error(activity.getClass().getName(),
					activity.getString(R.string.LABEL_DATABASE_ERROR), e);
			break;
	...
	private static void handleUserPersistError(Exception e, int mode,
			AopdsActivity activity) {
