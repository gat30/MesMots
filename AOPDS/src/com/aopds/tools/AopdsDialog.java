...
/**
 * 
 * @author Julien COUDSI August 2011 Provides static methods to display dialogs
 */
...
public class AopdsDialog {
	...
	public static void displayAlertOkDialog(String message,
			AopdsActivity activity) {
		AlertDialog.Builder builder = new AlertDialog.Builder(activity);
		builder.setMessage(message)
				.setCancelable(false)
				.setNegativeButton(activity.getString(R.string.LABEL_OK),
