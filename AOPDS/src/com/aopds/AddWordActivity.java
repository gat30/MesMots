...
public class AddWordActivity extends AopdsActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		concernedDictionary = (Dictionary) getIntent().getSerializableExtra(
	...
	public void initGui() {
		...
		languageFrom.setText(" ("
				+ concernedDictionary.getLanguageFrom().getName() + ")");
		...
		btAdd.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				AopdsDatabase db = AopdsDatabase
				...
				try {
					...
					displayMessageOK("The word " + s.getWord()
							+ " has been added ! ");
				} catch (AopdsDatabaseException e) {
					AopdsErrorHandler.handleError(e,
							AopdsErrorHandler.DATABASE_ERROR_DEFAULT,
