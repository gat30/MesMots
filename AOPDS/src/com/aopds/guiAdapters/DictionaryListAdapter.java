...
/**
 * 
 * Adapter for a dictionary list. This class is a bridge between 
 * a dictionary List and a ListView.
 * 
...
public class DictionaryListAdapter extends ArrayAdapterExtension<Dictionary> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ( textViewResourceId == R.layout.dictionary_update_list_item ) {
			...
			TextView displayDic = 
				(TextView) v.findViewById( R.id.dictionaryUpdateItem );
			
			if ( dictionary != null ) {
				displayDic.setText( dictionary.getCode() + " - " + dictionary.getVersion() );
			}
			...
			if (dictionary != null) {
				...
				TextView displayName = 
					(TextView) v.findViewById( R.id.dictionaryItemName);
			
				TextView displayLanguageFrom = 
					(TextView) v.findViewById( R.id.dictionaryItemLanguageFrom );
				
				TextView displayLanguageTo = 
					(TextView) v.findViewById( R.id.dictionaryItemLanguageTo );
				...
				if ( displayLanguageFrom != null ) {
					displayLanguageFrom.setText( dictionary.getLanguageFrom().getName() );
				}
				
				if ( displayLanguageTo != null ) {
					displayLanguageTo.setText( dictionary.getLanguageTo().getName() );
				}
