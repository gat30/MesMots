...
public class LanguageSpinnerAdapter extends ArrayAdapterExtension<Language> {
	 ...
	 *            The id of the XML layout which has to be used to display one
	 *            language.
	 * @param languages
	 ...
	 * 
	 * @param abreviation
	 *            The ISO-639 abbreviation of the searched language.
	 * @return The langauge whose the abbreviation is or null if not in the
	 *         adapter data set.
	 */
	...
	public View getDropDownView(int position, View convertView, ViewGroup parent) {
		...
		if (lang != null) {
			// displaying language
			TextView langView = (TextView) v
					.findViewById(R.id.languageItemName);
