...
/**
 * 
 * Adapter for a Suggestion List. This class is a bridge between a Suggestion
 * list and a ListView.
 * 
...
public class SuggestionListAdapter extends ArrayAdapterExtension<Suggestion> {
	 ...
	 *            The id of the Suggestion XML layout which has to be used to
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (s != null) {
			...
			TextView displayWord = (TextView) v
					.findViewById(R.id.suggestionWord);

			TextView displayAdminDecision = (TextView) v
					.findViewById(R.id.suggestionAdminDecision);
