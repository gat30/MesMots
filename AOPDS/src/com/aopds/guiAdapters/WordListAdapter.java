...
public class WordListAdapter extends ArrayAdapterExtension<AbstractWord> {
	 ...
	 *            The id of the headword XML layout which has to be used to
	 *            display a headword.
	 * @param words
	 *            The headwords to display.
	 */
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			case VIEW_TYPE_SUGGESTION:
				v = inflater.inflate(R.layout.search_word_suggestion_list_item,
						null);
				break;
			default:
				break;
		...
		if (word != null) {
			...
			if (type == VIEW_TYPE_SUGGESTION) {
				...
				if (sugg.getSynchroStatus().equals(
						Suggestion.SYNCHRO_STATUS_UNSYNCHRONIZED)) {
					v.setBackgroundColor(Color.BLUE);
				} else if (sugg.getSynchroStatus().equals(
						Suggestion.SYNCHRO_STATUS_WAITING)) {
					v.setBackgroundColor(Color.YELLOW);
				} else if (sugg.getSynchroStatus().equals(
						Suggestion.SYNCHRO_STATUS_REFUSED)) {
					v.setBackgroundColor(Color.RED);
				} else if (sugg.getSynchroStatus().equals(
						Suggestion.SYNCHRO_STATUS_ACCEPTED)) {
				...
				ImageView img = (ImageView) v
						.findViewById(R.id.searchWordSuggestionListItemImage);
				...
				TextView displayWord = (TextView) v
						.findViewById(R.id.suggestionTopText);

				TextView displayEntry = (TextView) v
						.findViewById(R.id.suggestionBottomText);
				...
				TextView displayWord = (TextView) v
						.findViewById(R.id.headwordTopText);

				TextView displayEntry = (TextView) v
						.findViewById(R.id.headwordBottomText);
