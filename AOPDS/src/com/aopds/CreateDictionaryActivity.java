...
public class CreateDictionaryActivity extends AopdsActivity {
	...
	public void initGui() {
		...
		LanguageSpinnerAdapter languageAdapter = new LanguageSpinnerAdapter(
				getApplicationContext(), R.layout.language_spinner_item,
		...
		try {
			languageAdapter.addAll(AopdsDatabase.getInstance(
					getApplicationContext()).getAllLanguages());
				...
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
						...
						if (isChecked) {
							...
							CreateDictionaryActivity.this
									.setSpinnerLanguageToEnable(false);
						} else {

							CreateDictionaryActivity.this
									.setSpinnerLanguageToEnable(true);
						}
	...
	protected void onSubmit() {
		...
		if (u != null) {
			...
			newDico.setLanguageFrom((Language) languagesSpinnerFrom
					.getSelectedItem());

			if (!checkMonolingualDictionary.isChecked()) {

				newDico.setLanguageTo((Language) languagesSpinnerTo
						.getSelectedItem());
			} else {
			...
			/*
			 * try { newDico = client.addDictionary(newDico, token, u.getId());
			 * AopdsDatabase db =
			 * AopdsDatabase.getInstance(getApplicationContext());
			 * db.saveDictionary(newDico);
			 * Toast.makeText(getApplicationContext(),
			 * getString(R.string.LABEL_DICTIONARY_ADDED),
			 * Toast.LENGTH_SHORT).show(); this.finish(); } catch
			 * (AopdsServiceConnectionImpossibleException e) { // TODO
			 * Auto-generated catch block AopdsLogger.error("ERR",
			 * e.getMessage(), e); Toast.makeText(getApplicationContext(),
			 * getString(R.string.LABEL_CONNEXION_IMPOSSIBLE),
			 * Toast.LENGTH_SHORT).show(); } catch
			 * (AopdsServiceMalformedResponseException e) { // TODO
			 * Auto-generated catch block AopdsLogger.error("ERR",
			 * e.getMessage(), e); } catch (AopdsServiceException e) { // TODO
			 * Auto-generated catch block AopdsLogger.error("ERR",
			 * e.getMessage(), e); } catch (AopdsServiceServerException e) { //
			 * TODO Auto-generated catch block AopdsLogger.error("ERR",
			 * e.getMessage(), e); }
			 */
