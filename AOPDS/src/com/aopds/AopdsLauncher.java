...
public class AopdsLauncher extends AopdsActivity {
	...
	private void updateAccountButton() {
		...
		//if the user is connected, we refresh the text of the button Log in / Sign up
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == TASK_MANAGE_DICTIONARY ) {
            if (resultCode == RESULT_OK) {
            	...
            	intent.putExtra(
            		"com.aopds.concernedDictionary", 
            		data.getSerializableExtra("com.aopds.pickedOutDictionary")
            	);
	...
	public void initGui() {
		...
		//Button dictionaryUpdateButton = (Button) findViewById( R.id.mainDictionaryUpdateButton );
		...
		/*logInSignUpButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				//If the user is connected, the program launches account activity
				if (getUserManager().isUserPersisted())
				{
					Intent intent = new Intent(
							getApplicationContext(), 
				...
				else //otherwise, it will be the log in activity
				{
					Intent intent = new Intent(
							getApplicationContext(), 
	...
	{	    	
		...
		if( getUserManager().isUserPersisted() )
		{
			...
			labelWelcome.setVisibility(View.VISIBLE);
			labelName.setVisibility(View.VISIBLE);
			labelName.setText(u.getFirstName());
		}
		else
		{
