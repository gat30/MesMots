...
public class ModifyWordActivity extends AopdsActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		modifiedWord = 
			(AbstractWord) getIntent().getExtras().getSerializable("com.aopds.wordToModify");
	...
	private void modifySuggestion( String word, String entry  ) {
		...
		if ( modifiedSuggestion.getSynchroStatus().equals( 
			...
			s.setCreationDate( new Date() );
			s.setDictionaryVersion( modifiedSuggestion.getDictionary().getVersion() );
	...
	private void onConfirmModification() {
		...
		if ( !(word.equals( modifiedWord.getWord() ) &&
				entry.equals( modifiedWord.getEntry() )) ) {
	...
	public void initGui() {
		...
		oldWord.setText(" ("+modifiedWord.getDictionary().getLanguageFrom().getName()+")");
		TextView newWord = (TextView) findViewById(R.id.ModifyWordEntryTextLang);
		newWord.setText(" ("+modifiedWord.getDictionary().getLanguageTo().getName()+")");
