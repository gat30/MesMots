 ...
 * 
 * This class manages all preferences and the way they are stored. Use this to change
 * any preference. <br><br>
 * 
 * Each time a preference is changed, the instance of this class will act as an observable
 * notifying all preferences listeners that a preference has been changed.<br><br>
 * 
...
public class AopdsPreferencesManager {
	...
	/**
	 * When called the first time, loads the preferences. If the preferences file
	 * is not existing or corrupted, load default preferences.
	 * 
	 * @param context The android application context.
	...
	/**
	 * Set the language of the application. All listeners will be notified 
	 * of the changing. 
	 * 
	 * Note that this method doesn't persist the changing, you must call persistPreferences()
	 * to persist it.
	 * 
	 * @param language The new language to set in ISO-639 language.
	 ...
	 * 
	 * @param language The language is verify in ISO-639 format.
	...
	private void loadAuthorizedLanguages() {
		...
		String[] languages = context.
								getResources().
									getStringArray(R.array.authorizedLanguages);
	 ...
	 * 
	 * @param pl The instance which has to listen to preferences changing.
	 */
	...
	/**
	 * @return True if the preferences are stored, false if nothing is persisted.
	 */
	 ...
	 * 
	 * @throws Exception If loading is impossible.
	 */
	private void loadPreferences() throws Exception {
        ...
        // setting input file
        xpp.setInput( 
        	new InputStreamReader( context.openFileInput(PREFERENCES_FILE_URL) )	
        );
	 ...
	 * 
	 * @throws Exception If persisting failed.
	 */
	public void persistPreferences() throws Exception {
		...
		OutputStreamWriter writer = new OutputStreamWriter( 
			context.openFileOutput(PREFERENCES_FILE_URL, Context.MODE_PRIVATE ) 
		);
	 ...
	 * @throws Exception If the preference is not existing or not correct.
	 */
	private void handlePreference(String preferenceName, String value) throws Exception {
